""" Perform the first pass of the context filtering.
It will automatically generate the bounding boxes of all the buildings.
    Inputs:
        ...
        _min_vf_criterion_: float: Minimum view factor criterion (in ]1:0[ )of a surface of a context building boundary box
...
ghenv.Component.Name = "BUA Perform First Pass Context Filtering"
ghenv.Component.NickName = 'PerformFirstPassContextFiltering'
