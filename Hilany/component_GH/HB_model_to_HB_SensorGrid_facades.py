...
def hb_model_to_hb_SensorGrid_facades(_name_,_model,_grid_size,_offset_dist_,quad_only_):
    ...
    model_sensorgrid_facades = _model.duplicate()  # duplicate to avoid editing the input
    if len(sensorgrid) != 0:
        model_sensorgrid_facades.properties.radiance.add_sensor_grid(sensorgrid)
