...
class BuildingModeled(BuildingBasic):
    ...
    def load_panels_roof(self, pv_tech_roof, list_irradiation_values_roof, minimum_ratio_energy_produced_on_used,
                         performance_ratio):
        """
    ...
    def load_panels_facades(self, pv_tech_facades, list_irradiation_values_facades,
        ...
        radiation simulation
        :param minimum_ratio_energy_produced_on_used: int: production minimal during the first year for a panel to be
    ...
    def panels_simulation_roof(self, path_folder_simulation_building, pv_tech,
                               minimum_ratio_energy_produced_on_used=1.2,
        ...
        if self.sensor_grid_dict["Roof"] is not None:
            ...
            self.load_panels_roof(pv_tech, radiation_values_in_list, minimum_ratio_energy_produced_on_used,
                                  performance_ratio)
    ...
    def panels_simulation_facades(self, path_folder_simulation_building, pv_tech, minimum_ratio_energy_produced_on_used,
        ...
        if self.sensor_grid_dict["Facades"] is not None:
            ...
            self.load_panels_facades(pv_tech, radiation_values_in_list, minimum_ratio_energy_produced_on_used,
                                     performance_ratio)
    ...
    def panel_simulation_building(self, path_folder_simulation_building, pv_technologies_dictionary, id_pv_tech_roof,
                                  id_pv_tech_facades, minimum_ratio_energy_produced_on_used=1.2, performance_ratio=0.75,
