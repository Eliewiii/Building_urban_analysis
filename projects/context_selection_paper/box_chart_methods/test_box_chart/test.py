...
def plot_xlog_box_chart(data: list, x_positions: list, x_label: str, y_label: str, fig_lengh: float = 6.,
                        fig_width: float = 9., base_width: float = 0.2, title: str = None,
