...
def test_from_polydata_to_rad_file():
    ...
    identifier = "test_1"
    from_polydata_to_rad_file(polydata_1, path_rad_file, identifier)

    path_rad_file = os.path.join(current_directory,"generated_file","rad_2.rad")
    identifier = "test_2"
    from_polydata_to_rad_file(polydata_2, path_rad_file, identifier)
...
def test_from_polydata_list_to_rad_file():
    ...
    from_polydata_list_to_rad_file(polydata_list, identifier_list, path_rad_file)
