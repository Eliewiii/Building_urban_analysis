...
python "%path_python_scripts%\components_gh\simulation_post_processing\main_simulation_post_process.py" -t 1 %* > "%LOCALAPPDATA%\Building_urban_analysis\Simulation_temp\out.txt" 2>&1
