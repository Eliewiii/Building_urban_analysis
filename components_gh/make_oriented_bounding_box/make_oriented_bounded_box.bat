...
python "%path_python_scripts%\mains_tool\make_oriented_bounding_box\main_make_oriented_bounding_box.py" -t 1 %* > "%LOCALAPPDATA%\Building_urban_analysis\Simulation_temp\out.txt" 2>&1
