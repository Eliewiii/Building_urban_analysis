...
class LoadArguments:
    ...
    def add_user_parameters_to_parser(parser):
        ...
        parser.add_argument("--minimum_ratio_energy_harvested_on_used", help="minimum energy production during the first year for the"
                                                                " panel to be installed",
                            default=default_minimum_ratio_energy_harvested_on_used)
    ...
    def parse_arguments_and_add_them_to_variable_dict(parser):
        ...
        arguments_dictionary = {
            ...
            "minimum_ratio_energy_harvested_on_used": int(args.minimum_ratio_energy_harvested_on_used),
