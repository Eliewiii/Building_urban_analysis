...
path_ubes_inputs = r"C:\Users\elie-medioni\OneDrive\OneDrive - Technion\Ministry of Energy Research\Papers\CheckContext\Simulations_Elie\Inputs\UBES_mini"  # todo : change to the correct path
name_building_folder_list = ["Office"]  # ["Residential", "Office"]
name_context_folder = "Context"
name_context_alternative_list = ["context_1", "context_2"]  #["context_1", "context_2", "context_3"]
